...
function PortalAuthCard({ onSignedIn }) {
...
function PortalReviewForm({ order, auth, onDone, onCancel }) {
...
function PortalReviewsList({ productId, auth, refresh }) {
